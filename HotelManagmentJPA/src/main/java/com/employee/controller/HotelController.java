...
import com.employee.service.HotelService;
...
public class HotelController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Hotel> updateHotel(@PathVariable Long id, @Valid @RequestBody Hotel updatedHotel, BindingResult result) {
